...
Customer newCustomer(){
    ...
    cout << setw(64)<<"welcome to dege cafe and restaurant:\n\n\n";
    cout << setw(72)<< "\t we are happy you came here, please sign up here to be our customer:\n\n\n ";

    cout << "please enter your first and last name respectivly: ";
    cin >> c[n].firstName >> c[n].lastName;

    cout << "\nplease enter your phone number: ";
    cin >> c[n].phoneNum;

    cout << "\nplease enter your credit card number and don't worry we will keep your privacy: ";
    cin >> c[n].creditCardNum;

    system("cls");

    cout <<"\n\n\n you have succesfuly finished your registration, Thanks for being our customer:\n ";
...
float logic(float bill ){
    restart:
    int payed, num; char y; string add;
    system("cls");
    ...
    if(y=='y'){
        ...
        for(int i = 0; i <100; i++){
            if(p_card[i].card_num = num ){
                ...
                payed =p_card[i].money - bill;
                cout << "your remaining amount from your purchase is : "<<payed;
            }
        }
    }
    else{
...
void manage_ingredient(){
    ...
    cout <<"|FOOD TYPE  |   NAME        |   PRICE       |   COST        |   QUANTITY |\n";
    cout << " ------------------------------------------------------------------------\n";
    for(int i =0; i < 7; i++){
        cout <<left << setw(14)<< bkfast[i].type<< setw(16)<< bkfast[i].name<< setw(16)<< bkfast[i].price<< setw(16)<< bkfast[i].cost<< setw(16)<< bkfast[i].quantity<<endl;
   }
   for(int i =0; i < 7; i++){
        cout <<left << setw(14)<< lun[i].type<< setw(16)<< lun[i].name<< setw(16)<< lun[i].price<< setw(16)<< lun[i].cost<< setw(16)<< lun[i].quantity<<endl;
   }
   for(int i =0; i < 7; i++){
        cout <<left << setw(14)<< din[i].type<< setw(16)<< din[i].name<< setw(16)<< din[i].price<< setw(16)<< din[i].cost<< setw(16)<< din[i].quantity<<endl;
   }
   for(int i =0; i < 7; i++){
        cout <<left << setw(14)<< des[i].type<< setw(16)<< des[i].name<< setw(16)<< des[i].price<< setw(16)<< des[i].cost<< setw(16)<< des[i].quantity<<endl;
   }
   system("pause");
   adminsterator();
}
...
/* 	cout <<  ltm->tm_mday << " / ";
 	cout << 1900 + ltm->tm_year << "                                      ";cout << "Time: "<< 1 + ltm->tm_hour << ":";
   	cout << 1 + ltm->tm_min << ":";
 	cout << 1 + ltm->tm_sec << endl;
 	cout <<"  CUSTOMER     : "<< p_card[n-1].name << endl;
 	cout <<"  Phone number : " << p_card[n-1].phone << endl;
 	cout <<"  subscription month : "<<p_card[n-1].period<<endl<<endl<<endl;
 	cout <<setw(64)<<"THIS WILL SERVE AS YOUR OFFICIAL CARD"<< endl<< endl<<endl;*/
 	system("pause");
 	mainMenu();
}
